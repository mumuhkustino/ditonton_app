...
void main() {
  ...
  group('Popular Tv Series', () {
    test('should return tv series list when call to domain source is success',
        () async {
      // arrange
  ...
  group('Top Rated Tv Series', () {
    test(
        'should return tv series list when call to domain source is successful',
        () async {
      // arrange
    ...
    test(
        'should return ServerFailure when call to domain source is unsuccessful',
        () async {
      // arrange
      when(mockTvSeriesRemoteDataSource.getTopRatedTvSeries())
          .thenThrow(ServerException());
  ...
  group('Get Tv Series Detail', () {
    ...
    test(
        'should return Tv Series domain when the call to remote domain source is successful',
        () async {
      // arrange
  ...
  group('Get Tv Series Episode', () {
    ...
    test(
        'should return Tv Series Episode domain when the call to remote domain source is successful',
        () async {
      // arrange
  ...
  group('Get Tv Series Recommendations', () {
    ...
    test('should return domain (tv series list) when the call is successful',
        () async {
      // arrange
