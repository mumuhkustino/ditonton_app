...
void main() {
  ...
  setUp(() {
    ...
    provider = MovieDetailNotifier(
      ...
      saveWatchlistMovies: mockSaveWatchlist,
      removeWatchlistMovies: mockRemoveWatchlist,
    )..addListener(() {
        listenerCallCount += 1;
      });
  });
  ...
  group('Watchlist', () {
    test('should get the watchlist status', () async {
      ...
      // act
      await provider.loadWatchlistStatusMovies(1);
      // assert
    ...
    test('should execute save watchlist when function called', () async {
      ...
      // act
      await provider.addWatchlistMovies(testMovieDetail);
      // assert
    ...
    test('should execute remove watchlist when function called', () async {
      ...
      // act
      await provider.removeFromWatchlistMovies(testMovieDetail.id);
      // assert
    ...
    test('should update watchlist status when add watchlist success', () async {
      ...
      expect(provider.isAddedToWatchlist, true);
      expect(provider.watchlistMessage, 'Added to Watchlist Movies');
      expect(listenerCallCount, 1);
    });
