...
void main() {
  ...
  group('Remove Watchlist Movie', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource.removeWatchlistMovie(testMovieTable.id))
          .thenAnswer((_) async => 'Removed from watchlist');
      // act
      final result = await repository.removeWatchlist(testMovieDetail.id);
      // assert
  ...
  group('Get Watchlist Movie', () {
    test('should return list of movie', () async {
      // arrange
